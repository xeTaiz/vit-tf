...
def compute_qkv(vol, batch_size=1, slice_along='z', dev=torch.device('cpu'), typ=torch.float32):
    ...
    image = make_4d(vol).permute(*permute_in)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--channel-reduction', type=str, choices=['add', 'mean', 'stack'], default='stack', help='How to reduce the resulting feature volumes')
